...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconPackage, IconSettings } from '@tabler/icons-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c14815fa58aab0bb1f483b?template=list_page"
