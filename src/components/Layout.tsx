...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconPackage, IconSettings, IconPlayerPlay, IconCode, IconTrash, IconChevronDown } from '@tabler/icons-react';
import { useState, useEffect, useRef } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import { useActions } from '@/context/ActionsContext';

const APP_TITLE = 'Einkaufsplaner';
...
const navigation = [
  ...
  { name: 'Produkte', href: '/produkte', icon: IconPackage },
  { name: 'Einkaufslisten', href: '/einkaufslisten', icon: IconFileText },
  { name: 'Einkaufseintraege', href: '/einkaufseintraege', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Produkte', href: '/gateway/apps/69c1480f8b2d1f1284e79d0a?template=list_page', icon: IconPackage },
  { name: 'Einkaufslisten', href: '/gateway/apps/69c148142a23cb12a67799b4?template=list_page', icon: IconFileText },
  { name: 'Einkaufseintraege', href: '/gateway/apps/69c14815fa58aab0bb1f483b?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c1480f8b2d1f1284e79d0a?template=list_page"
