...
const PROXY_BASE = '';
const APP_ID = '69c14815fa58aab0bb1f483b';
...
export default function PublicFormEinkaufseintraege() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Einkaufseintraege — Formular</h1>
        </div>
