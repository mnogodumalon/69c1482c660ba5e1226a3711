...
import type { Einkaufseintraege, Produkte, Einkaufslisten, CreateEinkaufseintraege, CreateProdukte, CreateEinkaufslisten } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async createEinkaufseintraegeEntry(fields: CreateEinkaufseintraege) {
    return callApi('POST', `/apps/${APP_IDS.EINKAUFSEINTRAEGE}/records`, { fields: cleanFieldsForApi(fields as any, 'einkaufseintraege') });
  }
  static async updateEinkaufseintraegeEntry(id: string, fields: Partial<CreateEinkaufseintraege>) {
    return callApi('PATCH', `/apps/${APP_IDS.EINKAUFSEINTRAEGE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'einkaufseintraege') });
  }
  ...
  static async createProdukteEntry(fields: CreateProdukte) {
    return callApi('POST', `/apps/${APP_IDS.PRODUKTE}/records`, { fields: cleanFieldsForApi(fields as any, 'produkte') });
  }
  static async updateProdukteEntry(id: string, fields: Partial<CreateProdukte>) {
    return callApi('PATCH', `/apps/${APP_IDS.PRODUKTE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'produkte') });
  }
  ...
  static async createEinkaufslistenEntry(fields: CreateEinkaufslisten) {
    return callApi('POST', `/apps/${APP_IDS.EINKAUFSLISTEN}/records`, { fields: cleanFieldsForApi(fields as any, 'einkaufslisten') });
  }
  static async updateEinkaufslistenEntry(id: string, fields: Partial<CreateEinkaufslisten>) {
    return callApi('PATCH', `/apps/${APP_IDS.EINKAUFSLISTEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'einkaufslisten') });
  }
